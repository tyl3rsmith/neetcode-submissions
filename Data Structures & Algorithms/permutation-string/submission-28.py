    ...
    def checkInclusion(self, s1: str, s2: str) -> bool:
        ...
        for r in range(len(s1), len(s2)):
            ...
            if s1Counts[index] == s2Counts[index]:
                matches += 1
            elif s1Counts[index] + 1 == s2Counts[index]: # they were equal but we broke a match by adding 1 to s2
                matches -= 1
            ...
            if s1Counts[index] == s2Counts[index]:
                matches += 1
            elif s1Counts[index] - 1 == s2Counts[index]: # they were equal but we broke a match by removing 1 from s2
                matches -= 1
